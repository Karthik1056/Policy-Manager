...
export default function AddTabModal({ isOpen, onClose, onSubmit, isPending, nextOrderIndex, editData, policyId }: AddTabModalProps) {
  ...
  return (
    <div className="bg-white rounded-lg p-4 w-full border shadow-sm animate-fade-in-up">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg font-bold text-gray-900">{editData ? "Edit Category" : "Add New Category"}</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            placeholder="e.g., Eligibility, Financials"
